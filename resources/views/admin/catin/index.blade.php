              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <span class="d-none d-sm-inline">
                    <a href="{{ url('administrator/data_catin/grafik') }}" class="btn">
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="table-responsive">
                    <table id="datatable-catin" class="table card-table table-vcenter table-bordered text-nowrap datatable bg-muted-lt">
                      <thead>
					   <tr >
						  ...
						  <th colspan="5" class="text-center">Catin Pria</th>
						  <th colspan="6" class="text-center">Catin Wanita</th>
						  <th rowspan="2" class="text-center">Tgl. Pernikahan</th>
						  <th colspan="8" class="text-center">Screening Catin Wanita</th>
						  <th colspan="3" class="text-center">Screening Catin Pria</th>
                ...
                <div class="card card-md">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col-10">
                        <h3 class="h1">Perlu Kunjungan Catin ?</h3>
...
<script>
    ...
    var table 	= $('#datatable-catin').DataTable( {
		"responsive": true,
        "processing": true,
        "serverSide": true,
		"ajax": {
            "url": BaseUrl+"/api/v1/catin/list",
            "data": data,
            "type": "POST",
        ...
        "columns": [
			{ "data": null },
            { "data": "nik_catin_pria" },
			{ "data": "nama_catin_pria" },
            { "data": "tgl_lahir_catin_pria" },
            { "data": "usia_catin_pria" },
            { "data": "alamat_catin_pria" },
			
            { "data": "nik_catin_wanita" },
            { "data": "nama_catin_wanita" },
            { "data": "tgl_lahir_catin_wanita" },
            { "data": "usia_catin_wanita" },
            { "data": "alamat_catin_wanita" },
            { "data": "telp_catin_wanita" },
			
            { "data": "tgl_pernikahan" },
            { "data": "tb_catin_wanita" },
            { "data": "bb_catin_wanita" },
            { "data": "imt" },
            { "data": "status_imt" },
            { "data": "kadar_hb" },
            { "data": "status_hb" },
	...
	$('#datatable-catin tbody').on( 'click', '#open', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_catin/open/"+data['id'];
    } );
	$('#datatable-catin tbody').on( 'click', '#riwayat', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_catin/kode_bumil/"+data['kode_catin'];
    } );
    
    $('#datatable-catin tbody').on( 'click', 'td:nth-child(2)', function () {
         var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_catin/open/"+data['id'];
