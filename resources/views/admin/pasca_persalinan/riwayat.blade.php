              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="table-responsive">
                    <table id="datatable-pasca_persalinan" class="table card-table table-vcenter table-bordered text-nowrap datatable bg-muted-lt">
                      <thead>
                        <tr >
...
<script>
    ...
    var table 	= $('#datatable-pasca_persalinan').DataTable( {
		"responsive": true,
        "processing": true,
        "serverSide": true,
		"ajax": {
            "url": BaseUrl+"/api/v1/pasca_persalinan/view_kode/"+id,
            "data": data,
            "type": "POST",
            ...
            "beforeSend": function(){ 
							$('#datatable-pasca_persalinan tbody').html('');
							$('.loader').show();
						},
		...
		"createdRow": function ( row, data, index ) {
		      ...
		      $('td', row).eq(18).addClass('bg-yellow-lt');
	...
	$('#datatable-pasca_persalinan tbody').on( 'click', '#open', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_pasca_persalinan/open/"+data['id'];
    } );
	 
    $('#datatable-pasca_persalinan tbody').on( 'click', 'td:nth-child(2)', function () {
         var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_pasca_persalinan/open/"+data['id'];
