              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <span class="d-none d-sm-inline">
                    <a href="{{ url('administrator/data_pasca_persalinan/grafik') }}" class="btn">
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="table-responsive">
                    <table id="datatable-pasca-persalinan" class="table card-table table-vcenter table-bordered text-nowrap datatable bg-muted-lt">
                      <thead>
					   <tr >
						  ...
						  <th colspan="12" class="text-center">Hasil Screening</th>
						 
						  
                          <th rowspan="2" class="text-center">Tgl. Kunjungan</th>
                          <th rowspan="2" class="text-center">Tgl. Kunjungan Berikutnya</th>
                ...
                <div class="card card-md">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col-10">
                        <h3 class="h1">Perlu Kunjungan Pasca Persalinan ?</h3>
...
<script>
    ...
    var table 	= $('#datatable-pasca-persalinan').DataTable( {
		"responsive": true,
        "processing": true,
        "serverSide": true,
		"ajax": {
            "url": BaseUrl+"/api/v1/pasca_persalinan/list",
            "data": data,
            "type": "POST",
            ...
            "beforeSend": function(){ 
							$('#datatable-pasca-persalinan tbody').html('');
							$('.loader').show();
						},
        ...
        "columns": [
            ...
            { "data": "jenis_komplikasi" },
            { "data": "kb_pasca_persalinan" },
			
            { "data": "jenis_kb" },
            { "data": "alasan_kb" },
            { "data": "alasan_tidak_kb" },
            { "data": "status_ibu" },
	...
	$('#datatable-pasca-persalinan tbody').on( 'click', '#open', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_pasca_persalinan/open/"+data['id'];
    } );
	$('#datatable-pasca-persalinan tbody').on( 'click', '#riwayat', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_pasca_persalinan/kode_pasca_persalinan/"+data['kode_pasca_persalinan'];
    } );
    
    $('#datatable-pasca-persalinan tbody').on( 'click', 'td:nth-child(2)', function () {
         var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_pasca_persalinan/open/"+data['id'];
