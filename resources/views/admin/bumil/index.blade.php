              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <span class="d-none d-sm-inline">
                    <a href="{{ url('administrator/data_bumil/grafik') }}" class="btn">
                ...
                <div class="card card-md">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col-10">
                        <h3 class="h1">Perlu Kunjungan Bumil ?</h3>
...
<script>
	...
	$('#datatable-bumil tbody').on( 'click', '#riwayat', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/administrator/data_bumil/kode_bumil/"+data['kode_bumil'];
    } );
